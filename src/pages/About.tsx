    ...
    <div>
      ...
      <section className="section-padding">
        <div className="mx-auto max-w-3xl text-center">
          <ScrollReveal>
            <img src="/logo_3_frecce_bdmedia.png" alt="BD Media logo" loading="lazy" width={596} height={596} className="mx-auto mb-6 h-[130px] w-[130px] object-contain bg-transparent" />
