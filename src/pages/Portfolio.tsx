...
const Portfolio = () => {
  ...
  const projects = [
    ...
    { sig: "AS",  cat: "architettura",   client: "AEON Studio",          headline: t(P.p2_headline), desc: t(P.p2_body), tags: ["Social Media", "Ads", t(PX.tag_growth)], logo: logoAS },
                  ...
                  <ScrollReveal key={p.sig} delay={i * 60}>
                    <div className="card-surface flex h-full flex-col">
                      <div className="flex items-start justify-between">
                        ...
                        {p.logo ? (
                          p.sig === "RN" ? (
                            <img src={p.logo} alt={p.client} className="h-20 w-20 rounded-full object-contain p-1 bg-white" />
                          ) : p.sig === "AL" ? (
